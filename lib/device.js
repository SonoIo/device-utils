...
Device.isIphoneXR = function isIphoneXR(force){
	...
	var dpr = _.isNumber(devicePixelRatio) && !_.isNaN(devicePixelRatio) ? devicePixelRatio : 1;
	deviceCache.isIphoneX = screen.height * dpr == 1792; // @ref: https://developer.apple.com/ios/human-interface-guidelines/visual-design/adaptivity-and-layout/
...
Device.isIphoneXSMax = function isIphoneXSMax(force){
	...
	var dpr = _.isNumber(devicePixelRatio) && !_.isNaN(devicePixelRatio) ? devicePixelRatio : 1;
	deviceCache.isIphoneX = screen.height * dpr == 2688; // @ref: https://developer.apple.com/ios/human-interface-guidelines/visual-design/adaptivity-and-layout/
